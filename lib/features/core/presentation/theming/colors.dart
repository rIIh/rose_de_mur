...
class Palette {
  static const MaterialColor primary = MaterialColor(_mainPrimaryValue, <int, Color>{
    50: Color(0xFFE5EDE9),
  ...
  static const MaterialColor primaryAccent = MaterialColor(_mainAccentValue, <int, Color>{
